                ...
                <div id="menu2" class="nav-box menuhd">
                    <ul>
                        ...
                        <li class="news">
                                ...
                                <router-link to="/daily">每日精选</router-link>
                        ...
                        <li class="video">
                                ...
                                <router-link to="/chaoshi">黑马超市</router-link>
                            
                        </li>
                        <li class="down">
                          <router-link to="/huiyuan">会员权益</router-link>
                        </li>
                        <li class="goods">
                          <router-link to="/shangcheng">购物商城</router-link>
                        </li>
                    </ul>
                </div>
